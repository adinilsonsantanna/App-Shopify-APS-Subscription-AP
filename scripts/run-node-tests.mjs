...
const result = spawnSync(process.execPath, ["--require", "./scripts/windows-node-user-shim.cjs", "--import", "tsx", "--test", "--test-reporter=tap", ...files], { encoding: "utf8", env: process.env });
