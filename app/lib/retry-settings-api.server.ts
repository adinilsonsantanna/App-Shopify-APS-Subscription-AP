...
export type RetrySettings = { paymentRetryAttempts: number; paymentRetryDays: number; paymentFailureAction: string; inventoryRetryAttempts: number; inventoryRetryDays: number; inventoryFailureAction: string; teamNotificationFrequency: string; updatedAt?: string | null };
